...
namespace CS.Data.Context.CustomerBoundedContext
{
    public class Sharding
    {
        ...
        public RangeShardMap<int> ShardMap { get; private set; }
        ...
        public Sharding(string smmserver, string smmdatabase, string smmconnstr)
        {
            ...
            RangeShardMap<int> sm;
            bool mapExists = ShardMapManager.TryGetRangeShardMap<int>("CustomerIDShardMap", out sm);
            if (!mapExists)
            {
                this.ShardMap = ShardMapManager.CreateRangeShardMap<int>("CustomerIDShardMap");
            }
            else
            {
                this.ShardMap = sm;
